...
//		helper.setTo("y.hammad96@outlook.com");
//		helper.setText("Here is your token "+user.getEmail());
...
//		javaMailSender.send(message);
		...
		try {
			...
			ExchangeCredentials credentials = new WebCredentials("yazeed.hammad@erabia.com", "QWEasd6767449*-");
			service.setCredentials(credentials);
			service.autodiscoverUrl("yazeed.hammad@erabia.com", new RedirectionUrlCallback());
           ...
           msg.setBody(new MessageBody(BodyType.HTML, image));
            msg.getToRecipients().add("y.hammad96@outlook.com"); //email receiver
